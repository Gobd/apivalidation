// Command gorilla demonstrates apivalidation with a gorilla/mux router.
//
// Run:
//
//	cd _example/gorilla && go run .
//
...
func main() {
	doc := openapi.DocBase("Example API (gorilla)", "Demonstrates apivalidation with gorilla/mux", "0.1.0")
	...
	r.PathPrefix("/swagger/").Handler(openapi.SwaggerHandlerMust("/swagger/", doc))
